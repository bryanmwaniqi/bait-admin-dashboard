$(function () {
  ...
  const salesBarChart = new Chart($("#salesBarChart"), salesBarConfig);
  ...
  const ordersChart = new Chart($("#ordersChart"), ordersConfig);
  ...
  const invoicesChart = new Chart($("#invoicesChart"), invoicesConfig);
  ...
  const returnsChart = new Chart($("#returnsChart"), returnsConfig);
  ...
  new ApexCharts(
    document.querySelector("#bestSellersChart"),
    options1
  ).render();

  // Overall sales line chart
  var lineGradientCtx = document
    .getElementById("lineGradientChart")
    .getContext("2d");
  ...
  const lineGradientChart = new Chart(lineGradientCtx, config);
});
